...
export const Solutions = ({ t, onAuth }: any) => (
  <section id="solutions" className="py-32 max-w-7xl mx-auto px-6 scroll-mt-20">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      {[
        { img: "https://images.unsplash.com/photo-1542362567-b05eef11f94d", label: "HQ View", title: t.org, desc: t.orgDesc, role: 'org' },
        { img: "https://images.unsplash.com/photo-1556740758-90de374c12ad", label: "Manager View", title: t.agency, desc: t.agencyDesc, role: 'agency' },
        { img: "https://images.unsplash.com/photo-1512428559087-560fa5ceab42", label: "User App", title: t.client, desc: t.clientDesc, role: 'client' },
      ].map((item, i) => (
        <div key={i} className="group card-pwa p-5 dark:bg-slate-800 dark:border-slate-700 hover:border-blue-600 transition-all">
          ...
          <button onClick={() => onAuth(item.role)}
