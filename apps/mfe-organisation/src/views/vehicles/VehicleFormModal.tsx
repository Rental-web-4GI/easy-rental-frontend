...
<<<<<<< HEAD
              ...
              <p className="text-[10px] text-slate-400 font-bold  tracking-widest mt-1 italic">Mise à jour exhaustive VehicleRequestDTO</p>
=======
...
<<<<<<< HEAD
                ...
                <Input label="Immatriculation" value={formData.licencePlate} onChange={(v:any) => setFormData({...formData, licencePlate: v.to()})} required icon={<Hash size={14}/>} />
=======
...
<<<<<<< HEAD
                    <label className="text-[9px] font-black text-slate-400  italic ml-1">Agence d&apos;affectation</label>
=======
...
>>>>>>> f89e8e59f63bc1dfac2a96703e19a8ccc0658d21
                ...
                <div className="space-y-1.5">
<<<<<<< HEAD
                    <label className="text-[9px] font-black text-slate-400  italic ml-1">Catégorie</label>
=======
...
<<<<<<< HEAD
                <h4 className="text-xs font-black text-[#0528d6]  italic flex items-center gap-2"><Settings size={16}/> Spécifications Techniques</h4>
=======
...
>>>>>>> f89e8e59f63bc1dfac2a96703e19a8ccc0658d21
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-1.5">
<<<<<<< HEAD
                        <label className="text-[9px] font-black text-slate-400  italic ml-1">Transmission</label>
=======
...
<<<<<<< HEAD
                <h4 className="text-xs font-black text-slate-900 dark:text-white  italic flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 pb-2"><Wind size={16} className="text-[#0528d6]"/> Équipements de Confort</h4>
=======
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.keys(formData.functionalities).map((key) => (
                        <label key={key} className="flex items-center gap-3 p-3 bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-800 rounded-2xl cursor-pointer hover:border-[#0528d6] transition-all group">
                            ...
                            />
                            <span className="text-[10px] font-black  text-slate-600 dark:text-slate-300 italic group-hover:text-[#0528d6]">{key.replace('_', ' ')}</span>
                        </label>
                    ))}
                </div>
            </div>
...
<<<<<<< HEAD
                    <h4 className="text-xs font-black text-slate-900 dark:text-white  italic flex items-center gap-2"><ImageIcon size={16} className="text-[#0528d6]"/> Galerie Photos</h4>
                    <button type="button" onClick={() => fileInputRef.current?.click()} disabled={uploading} className="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-[#0528d6] rounded-xl text-[10px] font-black  italic border border-blue-100 dark:border-blue-800 hover:bg-[#0528d6] hover:text-white transition-all flex items-center gap-2">
...
<<<<<<< HEAD
                            <p className="text-[10px] font-bold  italic">Aucune image pour ce véhicule</p>
=======
...
<<<<<<< HEAD
                <h4 className="text-xs font-black  italic flex items-center gap-2 text-blue-400"><ShieldCheck size={16}/> Conformité & Assurance</h4>
=======
...
<<<<<<< HEAD
            ...
            <button type="submit" disabled={modalLoading || uploading} className="flex-[2] py-4 bg-[#0528d6] text-white rounded-2xl font-black text-xs  shadow-xl shadow-blue-600/20 hover:bg-blue-700 transition-all flex items-center justify-center gap-2">
...
const Input = ({ label, value, onChange, type = "text", icon, dark, placeholder, required }: any) => (
  <div className="space-y-1.5">
    <label className={`text-[9px] font-black  italic ml-1 tracking-widest ${dark ? 'text-slate-400' : 'text-slate-400'}`}>{label}</label>
